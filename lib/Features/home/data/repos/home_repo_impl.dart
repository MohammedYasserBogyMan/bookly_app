...
class HomeRepoImpl implements HomeRepo {
  ...
  @override
  Future<Either<Failure, List<BookModel>>> fetchFuaturedBooks() async {
    try {
      var data = await apiService.get(endPoint: 'volumes?q=best');
  ...
  Future<Either<Failure, List<BookModel>>> fetchSimlaerBooks(
    ...
    try {
      var data = await apiService.get(endPoint: 'volumes?q=$catigory');
